<template>
  <div
    class="border rounded-lg shadow-md p-4 bg-white transition-transform hover:scale-105 hover:shadow-lg"
  >
    <nuxt-img :src="cat?.url" alt="Cat" class="h-40 w-full object-cover rounded-lg mb-4" />
